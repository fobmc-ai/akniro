...
TRANSITIONS = {
    ...
    "review": {"REQUESTED": {"IN_REVIEW", "CANCELLED"}, "IN_REVIEW": {"APPROVED", "CHANGES_REQUESTED", "CANCELLED"}, "CHANGES_REQUESTED": {"IN_REVIEW"}, "APPROVED": {"SUPERSEDED"}, "SUPERSEDED": set(), "CANCELLED": set()},
