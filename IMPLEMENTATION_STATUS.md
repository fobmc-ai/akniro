...
| HMI-001 | HMI 能力、标签/报警绑定检查、确定性工程包构建 | VALIDATED-SW |
| EDA-001 | IO/BOM 一致性检查、确定性工程包构建 | VALIDATED-SW |
| MOT-001 | 轴仿真、限位、状态机检查、确定性工程包构建和人工门禁 | VALIDATED-SW / CONTRACT_ONLY |
| VIS-001 | 数据集 Hash、阈值、回归集检查、确定性工程包构建 | VALIDATED-SW |
| ROB-001 | 握手、权限范围、故障恢复检查、确定性工程包构建 | VALIDATED-SW |
| QUAL-001/002 | Logical Digital Twin、故障注入、依赖诊断、Test Run、Evidence、工具验证矩阵、Release Gate | VALIDATED-SW |
| PM-001/002 | 项目、成员、实体、Review、追溯图、数据完整性审计、事件 Outbox、审计和租户隔离 | VALIDATED-SW |
