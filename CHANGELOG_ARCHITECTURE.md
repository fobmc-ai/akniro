...
- Added `IMPLEMENTATION_AUDIT.md` as the single acceptance matrix for all 14 engineering capabilities, evidence routes, one-command verification, and explicit field-certification boundaries.
