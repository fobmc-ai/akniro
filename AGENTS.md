...
1. Read this file, `MASTER_PLAN.md`, `FOUNDATION_CONTRACT.md`, `DATA_INTERACTION_CONTRACT.md`, `CHANGE_CONTROL_RULES.md`, `docs/00-master/PROJECT_INDEX.md`, `docs/00-master/ARCHITECTURE_MAP.md`, and the relevant domain documents before changing anything.
...
8. Do not begin Phase 1 PLC control implementation until the Phase 0 foundation contract and its contract tests pass.
