...
|---|---|---|---|---|---|
| TD-001 | Deterministic soft runtime is not a certified realtime runtime | high | before first edge pilot | Runtime | mitigated — PLC cycle/watchdog/fault-safe simulator and evidence path implemented; field realtime certification remains open |
