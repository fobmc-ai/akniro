...
| Cloud | fleet, sync, remote access, OTA | B |
| AI | governed context, agents, model gateway | A/B |
| Mobile/Tablet HMI | responsive operational clients | B |
| App Center | signed apps/plugins/licenses | B |
