...
samples = [
    ...
    ('TC-HMI-001', 'test_case', 'HMI duplicate tag regression', {'designGoal': 'Detect duplicate PLC-HMI tag bindings', 'acceptanceCriteria': ['Duplicate tag is rejected', 'No unknown tags remain'], 'testPlan': 'HMI-001:golden-validation'}),
